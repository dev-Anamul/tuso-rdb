...
export const getRoleData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/tuso-api/user-roles`);
...
export const getRoleByModule = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/module-permission/module/${id}`
    );
    return response.data;
  }
);
...
export const getSingleRoleData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/tuso-api/user-role/key/${id}`);
    console.log(response.data);
    return response.data;
  }
);
...
export const addRoleData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/user-role`, data);
...
export const updateRoleData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(`${process.env.REACT_APP_API_URL}/tuso-api/user-role/${data.oid}`, data);
    await dispatch(getRoleData());
  }
);
...
export const deleteRole = createAsyncThunk(
  "roleData/deleteRole",
  async (id, { dispatch }) => {
    await axios.delete(`${process.env.REACT_APP_API_URL}/tuso-api/user-role/${id}`);
    await dispatch(getRoleData());
  }
);
