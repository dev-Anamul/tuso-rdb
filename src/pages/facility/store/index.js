...
export const getFacilityData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/facilities`
    );
...
export const getSingleFacilityData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/facility/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addFacilityData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/facility`,
      data
    );
...
export const updateFacilityData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/facility/${data.oid}`,
      data
    );
    await dispatch(getFacilityData());
    await dispatch(getFacilityByDistrict(data.districtID));
...
export const deleteFacility = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/facility/${data?.id}`
    );
    await dispatch(getFacilityData());
    await dispatch(getFacilityByDistrict(data?.districtID));
  }
