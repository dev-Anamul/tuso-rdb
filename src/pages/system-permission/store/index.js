...
export const getSystemPermissionData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/system-permissions`
    );
...
export const addSystemPermissionData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/system-permission`,
      data
    );
...
export const addSystemPermissionPermission = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/SystemPermission-permission`,
      data
    );
    await dispatch(getSystemPermissionData());
  }
...
export const updateSystemPermissionData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/SystemPermission/${data.oid}`,
      data
    );
    await dispatch(getSystemPermissionData());
  }
...
export const deleteSystemPermission = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/system-permission/${data.systemID}`
    );
    await dispatch(getSystemPermissionData());
    await dispatch(getSystemPermissionByRoleId(data.userAccountID));
  }
