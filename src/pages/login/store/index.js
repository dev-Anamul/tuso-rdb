...
export const getLoggedIn = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/login`,
      data
    );
    const userObj = {
...
export const changePassword = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/changepassword`,
      data
    );
...
export const passwordRecovery = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/recovery-request`,
      data
    );
    console.log(response.data);
    return response.data;
...
export const getRecoveryListData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/recovery-requests`
    );
    console.log(response.data);
    return response.data;
  }
...
export const adminRecoveyPassword = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/recovery-password`,
      data
    );
