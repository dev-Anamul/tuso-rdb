...
export const getModuleData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/modules`
    );
...
export const getSingleModuleData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/module/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getModulePermissionData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/module-permission/role/${id}`
    );
    console.log(response.data);
...
export const addModuleData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/module`, data);
...
export const addModulePermission = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/module-permission`,
      data
    );
    await dispatch(getModuleData());
...
export const deleteModulePermission = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/module-permission/${data.permissionID}`
    );
    await dispatch(getModuleData());
    await dispatch(getModulePermissionByRoleId(data.roleID));
  }
...
export const updateModuleData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/module/${data.oid}`,
      data
    );
    await dispatch(getModuleData());
  }
...
export const deleteModule = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/module/${id}`
    );
    await dispatch(getModuleData());
  }
);
