...
function ProjectTableRow({ item, editFunction, deleteFunction, handleUsers }) {
  ...
  return (
    <tr className="border-bottom border-2">
      <td className={`font-fallback w-50 texttd__font-size fw-bolder`}>
        {item?.title} <br />{" "}
        <span className="font-fallback texttd__font-size p-0 fw-normal">
          {item?.description}
        </span>
      </td>
