...
export const getProjectData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/systems`
    );
...
export const getSingleProjectData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/system/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getSystemPermissionByRoleId = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/system-permission/user/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getUserByProject = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/system-permission/system/${id}`
    );
    return response.data;
  }
);
...
export const addProjectData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/system`, data);
...
export const updateProjectData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/system/${data.oid}`,
      data
    );
    await dispatch(getProjectData());
  }
...
export const deleteProject = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/system/${id}`
    );
    await dispatch(getProjectData());
  }
);
