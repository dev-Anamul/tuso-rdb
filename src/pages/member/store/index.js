...
export const getMemberData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/members`
    );
...
export const addMemberData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/member`, data);
...
export const addMemberPermission = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/member-permission`,
      data
    );
    await dispatch(getMemberData());
  }
...
export const updateMemberData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/member/${data.oid}`,
      data
    );
    await dispatch(getMemberData());
  }
...
export const deleteMember = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/member/${data.id}`
    );
    await dispatch(getMemberData());
    await dispatch(getMembersByTeamId(data.teamID));
  }
