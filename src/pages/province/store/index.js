...
export const getProvinceData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/provinces`
    );
...
export const getSingleProvinceData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/province/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addProvinceData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/province`,
      data
    );
...
export const getDistrictByProvince = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/district/province/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const updateProvinceData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/province/${data.oid}`,
      data
    );
    await dispatch(getProvinceData());
    await dispatch(getProvinceByCountry(data.countryID));
...
export const deleteProvince = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/province/${data.id}`
    );
    await dispatch(getProvinceData());
    await dispatch(getProvinceByCountry(data.countryID));
  }
