...
// import { processs.env.REACT_APP_API_URL } from "../../../config";
...
export const getDistrictData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/districts`
    );
...
export const getSingleDistrictData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/district/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getFacilityByDistrict = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/facility/district/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addDistrictData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/district`,
      data
    );
...
export const updateDistrictData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/district/${data.oid}`,
      data
    );
    await dispatch(getDistrictData());
    await dispatch(getDistrictByProvince(data.provinceID));
...
export const deleteDistrict = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/district/${data?.id}`
    );
    await dispatch(getDistrictData());
    await dispatch(getDistrictByProvince(data?.provinceID));
  }
