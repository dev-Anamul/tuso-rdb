...
export const getPriorityData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-priorities`
    );
...
export const getSinglePriorityData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-priority/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addPriorityData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-priority`,
      data
    );
...
export const updatePriorityData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    ...
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-priority/${data.oid}`,
      data
    );
    await dispatch(getPriorityData());
  }
...
export const deletePriority = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-priority/${id}`
    );
    await dispatch(getPriorityData());
  }
);
