...
export const getCountryData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/countries`
    );
...
export const getSingleCountryData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/country/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getProvinceByCountry = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/province/country/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addCountryData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/country`, data);
...
export const updateCountryData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/country/${data.oid}`,
      data
    );
    await dispatch(getCountryData());
  }
...
export const deleteCountry = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/country/${id}`
    );
    await dispatch(getCountryData());
  }
);
