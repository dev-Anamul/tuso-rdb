...
export const getTeamData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/teams`
    );
...
export const getSingleTeamData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/team/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addTeamData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(`${process.env.REACT_APP_API_URL}/tuso-api/team`, data);
...
export const updateTeamData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/team/${data.oid}`,
      data
    );
    await dispatch(getTeamData());
  }
...
export const deleteTeam = createAsyncThunk(
  "teamData/deleteTeam",
  async (id, { dispatch }) => {
    await axios.delete(`${process.env.REACT_APP_API_URL}/tuso-api/team/${id}`);
    await dispatch(getTeamData());
  }
);
...
export const getMembersByTeamId = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/member/team/${id}`
    );
    console.log(response.data);
    return response.data;
  }
