...
export const getTicketData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents?start=${data?.start}&take=${data?.limit}&status=${data?.status}`
    );
...
export const clientTicketData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents/client?key=${data.key}&start=${data.start}&take=${data.limit}&status=${data.status}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getExpertTicketData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents/expart?key=${data.key}&start=${data.start}&take=${data.limit}&status=${data.status}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getExpertTeamLeaderTicketData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents/expartleader?key=${data.key}&start=${data.start}&take=${data.limit}&status=${data.status}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getFilterdTicketData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents/search?start=${data.start}&take=${data.limit}`,
      data.serchObj
    );
    console.log(response.data);
    return response.data;
...
export const getTicketById = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incidents/key?key=${data?.key}&UserAccountID=${data?.UserAccountID}&start=${data?.start}&take=${data?.limit}&status=${data?.status}`
    );
...
export const getSingTicketData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addTicketData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident`,
      data
    );
    console.log(response.data);
    return response.data;
...
export const updateTicketData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident/${data.oid}`,
      data
    );
...
export const closeListTicketData = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident/close/${id}`
    );
  }
);
...
export const deleteTicket = createAsyncThunk(
  ...
  async (id, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident/${id}`
    );
  }
);
...
export const uploadScreenShot = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/screenshot/${data?.id}`,
      data?.img,
      {
        headers: {
...
const TicketDataSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(clearUploadAttachment.fulfilled, (state) => {
