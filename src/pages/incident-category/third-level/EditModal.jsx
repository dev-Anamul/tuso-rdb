...
import { updateThirdLevelIncidentCategory } from "../store";
...
function EditModal({ open, setOpen }) {
  ...
  const data = useSelector(
    (state) => state.incidentCategory.selectedThirdLevelIncidentCategory
  );
  ...
  const onSubmit = () => {
    ...
    if (validation.isValid) {
      dispatch(updateThirdLevelIncidentCategory(newIncident));
      setIncidentName("");
      setDescription("");
      setValidationResult({});
      setOpen(false);
                ...
                <Col md={12} className="font-fallback default-fz my-2">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <Label className="form-label" for="name">
                      ...
                      <span className="orange-400">*</span>
                    </Label>
