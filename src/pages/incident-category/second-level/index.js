...
import FirstLevelTable from "./SecondLevelTable";
  ...
  return (
    <Layout>
      <Row className="">
        <Col sm="12">
          <div>
            <div className="display-6 font-fallback">Second Level Category</div>
            ...
            <Card className="px-4 py-4 border-0 shadow overflow-auto">
              <div className="mb-3 d-flex justify-content-between align-items-center responsive_table_class">
                ...
                >
                  <PlusCircle size={20} className=" me-1 mb-1" /> Add Second
                  Level Category
                </Button>
                <Button
                  outline
