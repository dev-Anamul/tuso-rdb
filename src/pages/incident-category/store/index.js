...
export const getIncidentCategoryData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-categorys`
    );
...
export const getTreeViewData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-categorystreeview`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getIncidentCategoryByParent = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-categorys/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getSingleIncidentCategoryData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-category/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addIncidentCategoryData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    if (data.secondParent) {
      await axios.post(
        `${process.env.REACT_APP_API_URL}/tuso-api/incident-category`,
        data.data
      );
...
export const updateIncidentCategoryData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-category/${data.oid}`,
      data
    );
    await dispatch(getIncidentCategoryData());
    await dispatch(getIncidentCategoryByParent(data.parentID));
...
export const deleteIncidentCategory = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    ...
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/incident-category/${data.id}`
    );
    if (data.parentID) {
      await dispatch(getIncidentCategoryData());
      await dispatch(getIncidentCategoryByParent(data.parentID));
