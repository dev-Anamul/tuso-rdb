...
export const getUserData = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/role/${
        data?.roleID || 0
      }?start=${data?.start}&take=${data?.limit}`
    );
...
export const searchUserByName = createAsyncThunk(
  ...
  async (data) => {
    ...
    let cancel;
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-accounts/name?name=${data?.name}&start=${data?.start}&take=${data?.limit}`,
      {
...
export const getSingleUserData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/key/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const getExpertUserData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/expert`
    );
    console.log(response.data);
    return response.data;
  }
...
export const addUserData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account`,
      data?.newIncident
    );
...
export const getTeamLeaderData = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/member/user/${id}`
    );
    console.log(response.data);
    return response.data;
  }
...
export const updateUserData = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.put(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/${data.oid}`,
      data
    );
...
export const uploadProfileImg = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.post(
      `${process.env.REACT_APP_API_URL}/tuso-api/profile-picture/${data.id}`,
      data.image,
      {
        headers: {
...
export const getUerImage = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/profile-picture/key/${id}`
    );
    return response.data;
  }
);
...
export const deleteUser = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    await axios.delete(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/${data?.id}`
    );
    await dispatch(getUserData(data?.filterObj));
  }
);
...
export const checkUniqueUsername = createAsyncThunk(
  ...
  async (username) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/unique/${username}`
    );
    return response.data;
  }
);

export const checkUniqueCellPhone = createAsyncThunk(
  "userData/checkUniqueCellPhone",
  async (cellPhone) => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/tuso-api/user-account/unique-cellphone/${cellPhone}`
    );
    return response.data;
  }
);
...
const userDataSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(checkUniqueCellPhone.fulfilled, (state, action) => {
      state.uniqueCellPhone = action.payload;
    });
